const allprojects = [
  ...
  },
  {
    name: "Tic Tac Toe",
    caption:
      "This application effectively demonstrates React's capabilities and offers an interactive, responsive user experience. #WebDevelopment",
  ...
  },
  {
    name: "Music Player",
    caption:
      "This music player was created using HTML, CSS and JavaScript. The music player features a modern design, with a user-friendly interface that allows users to easily control their music. #WebDevelopment",
